...
//datos SQL
        ...
        $this->SetXY($lw,$lh+20);
        $this->MultiCell(170,3,'LISTA DE PRECIOS HDTVI',0,'C');
...
vDescrip,nCosto,nStock,a.vEstado, Case when iadjunto='' then '1.jpg'
 else  iadjunto   end as img,b.vNombre + ' '+a.vResolucion as subcateria,isnull(c.norden,0)
 ...
 where
	(vTecnologia='HDTVI' and 	vMarca='Hikvision')

	OR (b.vnombre = 'Disco Duro' and vmarca='Western Digital')

 order by b.orden asc,vTecnologia,isnull(c.norden,0) asc");
