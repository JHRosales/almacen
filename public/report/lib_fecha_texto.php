...
function numtoletrasSOLES($xcifra){
    $cadena=numtoletras($xcifra);
    $xcifra = trim($xcifra);
    $xpos_punto = strpos($xcifra, ".");
    $xdecimales = "00";
    if (!($xpos_punto === false)) {
    ...
    return trim($cadena.' CON '.$xdecimales.'/100');
}
...
function fechaATexto($fecha){
 ...
 // return "$dia de $mes de $anio.";
  //  return "$fecha_separada[0] de $mes del año $anio."; // Todo texto
    return "$fecha_separada[0] de $mes del $fecha_separada[2]"; //Solo mes en texto
}
?>
